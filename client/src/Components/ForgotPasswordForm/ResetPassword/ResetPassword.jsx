  ...
  const handleSubmit = (e) => {
    ...
    ResetUserPassword(id, token, { password })
      .then((result) => {
        ...
        setShowResetPassword(false); // Close the form
        setTimeout(() => {
    ...
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
        ...
        >
          ...
          <button
            type="submit" // Ensure this is submit, so the form is triggered
          ...
          <img
            ...
            alt="Close"
            onClick={() => setShowResetPassword(false)} // Close form when cross is clicked
          />
        </motion.form>
      </div>
    </>
